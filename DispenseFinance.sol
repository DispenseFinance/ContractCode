...
contract DispenseFinance is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Dispense Finance";
    ...
    // Innovation for protocol by DispenseFinance Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own DFI to claim reward');
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 104 weeks;
